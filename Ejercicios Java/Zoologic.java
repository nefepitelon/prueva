//69 Crear una clase Animal con variables especie y edad.
//70 Crear una clase Zoologico con una lista de animales.
//71 Crear un método en Zoologico que imprima la especie de todos los animales.
...
public static void main(String[] args) {
    Zoologic zoologico = new Zoologic(); //Crea un objeto Garaje
